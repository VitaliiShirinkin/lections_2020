...
26. Лекция 11 (осень): https://www.youtube.com/live/GAarEgus7WQ?feature=share объяснение задачи поиска кратчайшего пути в графе, алгоритм "Дэйкстры", объяснение принципа работы, когда нельзя применять данный алгоритм, Алгоритм " Флойда -Уоршелла", объяснение принципа работы, "Весовая матрица", Вычисление алгоритма " Флойда - Уоршелла " при помощи табличного процессора.
27. Лекция 12 (осень): https://www.youtube.com/live/F470JpOUfrg?feature=share Обход "Графа" в ширину(BFS) и глубину(DFS), объяснение, Реализация обхода "Графа" в глубину, Обход "Графа" в ширину, объяснение, Реализация обхода "Графа" в ширину.
